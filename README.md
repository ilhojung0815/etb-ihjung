...
# 7. 마치며
<div>이번 프로젝트는 학부를 졸업한 뒤 처음으로 진행하는 팀프로젝트였다. 졸업 후 2년이라는 긴 시간동안의 공백 후 처음으로 진행하는 프로젝트라 잘할 수 있을까에 대한 걱정도 많았지만 좋은 팀원들을 만나서 서로 많이 서툰 실력들이지만 해결하기 어려웠던 문제들을 다같이 해결해나가고 응원하면서 많은 것들을 배울 수 있었던 기회였다. 기술을 학습하는 것도 의미가 있었지만, 팀이라는 것에 대해 한번 더 생각하고 배울 수 있었던 점이 이번 프로젝트에서의 가장 큰 성과였던 것 같다.</div>
